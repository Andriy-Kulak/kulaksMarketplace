...
class HomePage extends Component {
  ...
  render() {
    ...
    const title = userShops.length === 0 ?
      'There are currently no stores created. If you want to test the app, <br /> then become a Shop Owner by heading over to Shop Owner page and Create Shops and Products.' :
      'Available Shops'
    return (
      <Layout>
        <AdminTestPanel
